...
const Cart = () => {
  ...
  return (
          ...
          <div className="flex">
            ...
            <div className="flex flex-row justify-between">
              <div>
                ...
                <p class="text-sm">your order not accepted</p>
              </div>
              <button
                type="button"
                class="ms-auto -mx-1.5 -my-1.5 bg-green-50 text-green-500 rounded-lg focus:ring-2 focus:ring-green-400 p-1.5 hover:bg-green-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-green-400 dark:hover:bg-gray-700"
    ...
    <div style={{minHeight:"95vh"}} className="flex items-center">
      <div className="container mx-auto flex border-graidient  p-3 pb-10 m-10 rounded-lg flex-col">
            ...
            <div className="overflow-hidden">
              {
                ...
                <button onClick={handleCheckOut} className="border dark:border-gray-400 border-gray-900 rounded p-2 bg-gradient-to-r from-indigo-700 via-violet-700 to-orange-700  hover:text-gray-100 "
                    >Checkout</button>
                </>
